...
class LaneNetDataProducer(object):
    ...
    def __init__(self):
        ...
        print(self._train_example_index_file_path)
        print(self._test_example_index_file_path)
        print(self._val_example_index_file_path)
    ...
    with tf.Session() as sess:
        while True:
            try:
                ...
                print(err)
                raise errself._val_example_index_file_path
